...
public class AdapterEjercicio extends BaseAdapter {

    protected Activity activity;
    protected ArrayList<Ejercicio> items;

    public AdapterEjercicio(Activity activity, ArrayList<Ejercicio> items) {
    ...
    public void addAll(ArrayList<Ejercicio> category) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) { /* Así hacemos que se vea en el ListView */
        ...
        Ejercicio dir = items.get(position);
