...
CREATE TABLE SESIONES(
    ...
    CONSTRAINT FK_SESIONES_ENTRENADOR FOREIGN KEY (ID_ENTRENADOR) REFERENCES ENTRENADORES (ID_ENTRENADOR)
)ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE ASISTENCIAS(
    ...
    CONSTRAINT FK_ASISTENCIAS_ENTRENADOR FOREIGN KEY (ID_ENTRENADOR) REFERENCES ENTRENADORES (ID_ENTRENADOR)
)ENGINE = InnoDB DEFAULT CHARSET = utf8;
